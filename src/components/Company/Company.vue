<template>
  <b-container fluid class="screen">
    <b-row>
      <b-col md="12">
        <a class="btn-return" @click="returnToCompanies">
          ...
          <b-container fluid class="company-detail">
            <b-row no-gutters style="margin: 0 10px;" class="detail-info">
              <b-col cols="12" md="6" class="text-left">
                <h3>RFC: <span>{{ selected.rfc }}</span></h3>
              </b-col>
              <b-col cols="12" md="6" class="text-left">
                <h3>Nombre comercial: <span>{{ selected.companyName }}</span></h3>
              </b-col>
              <b-col cols="12" md="6" class="text-left">
                <h3>Email: <span>{{ selected.email }}</span></h3>
              </b-col>
              <b-col cols="12" md="6" class="text-left">
                <h3>Razón Social: <span>{{ selected.businessLine }}</span></h3>
              </b-col>
              <b-col cols="12" md="6" class="text-left">
                <h3>Teléfono: <span>{{ selected.phone }}</span></h3>
              </b-col>
            </b-row>
            <hr/>
            <b-row>
...
export default defineComponent({
  ...
  props: {
    selected: {type: Company, required: true}
  },
  data() {
    return {
      txtSearch: '',
  ...
  methods: {
    getList(){
      this.axios.get(`client/${this.selected.id}`).then((response: any) => {
